    ...
    <section className={styles.section} id="einzugsgebiet" aria-labelledby="area-title">
      <header className={styles.head}>
        ...
        <div>
          ...
          <p className={styles.sub}>Hausbesuche in Sankt Augustin, Bonn, Siegburg und Umgebung.</p>
        </div>
      </header>
      <div className={styles.grid}>
        <div className={styles.info}>
          <p className={styles.intro}>
            Ich behandle Patientinnen und Patienten in einem Umkreis von 20 km um Sankt Augustin.
            Hier eine Auswahl der Orte, in denen ich regelmäßig Hausbesuche durchführe:
          </p>
          ...
          <p className={styles.outro}>
            Ihre Stadt ist nicht dabei? Schreiben Sie mir &mdash; vieles lässt sich einrichten.
          </p>
        </div>
