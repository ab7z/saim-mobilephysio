...
const FAQ = [
  ...
  },
  {
    ...
    a: "Ihr ärztliches Rezept (sofern vorhanden), bequeme Kleidung und gegebenenfalls Vorbefunde. Ich bringe alles Übrige zusammen mit den Materialien mit",
  },
  {
      ...
      <header className={styles.head}>
        ...
        <div>
          ...
          <p className={styles.sub}>
            Klären Sie häufige Punkte vor dem ersten Termin — oder sprechen Sie mich direkt an.
          </p>
        </div>
      </header>
