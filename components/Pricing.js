...
const Arrow = () => (
  ...
  >
    <path
      d="M2 22 H72 V8 L118 32 L72 56 V42 H2 Z"
      fill="#2c8410"
      stroke="#2c8410"
      strokeWidth="2"
...
const THERAPIE = [
  {
    name: "Physiotherapeutischer Erstbefund zur Erstellung eines Behandlungsplans",
    time: "",
    price: "40,00 €",
  },
...
const PHYSIKAL = [
  {
    name: "Niedrig/Hoch Frequenz (Ozontherapie) mit MFT gleichzeitig",
    time: "30 min",
    price: "150,00 €",
  },
      ...
      <div className={styles.wrap}>
        ...
        <div className={styles.kalk}>
          ...
          <div className={styles.kalkText}>
            ...
            <div>
              In jeder Praxis erhält man in der Regel für eine normale Krankengymnastik meist nur
              bis zu 15 Minuten Behandlung (die Zeit zum An- und Ausziehen nicht mitgerechnet) und
              zahlt dafür durschnittlich 42 Euro oder auch mehr!
            </div>
          </div>
          <Arrow />
          <ClockA />
          ...
          <div className={styles.kalkText}>
            ...
            <div>
              Bei mir bekommt man mehr Behandlung!
              <br />
        ...
        <table className={styles.table}>
          <caption className={styles.srOnly}>
            Honorarkatalog Therapieangebote und Physikalische Maßnahmen
          </caption>
          <thead>
            <tr className={styles.sec}>
              ...
              <th className={styles.r} scope="col">
                Zeit
              </th>
              <th className={styles.r} scope="col">
                Honorar
          ...
          <tbody>
            {THERAPIE.map((row) => (
              <tr className={styles.row} key={row.name}>
                <td className={styles.lbl} colSpan="2">
                  {row.name}
                </td>
