...
export const DEFAULT_DESCRIPTION = 'Mobile Physiotherapie in Sankt Augustin, Bonn und Umgebung: Hausbesuche, Manualtherapie, Lymphdrainage und Personal Training mit Faranak Nokhbehzaeem.';
...
export const FAQ_ITEMS = [
    ...
    },
    {
        ...
        answer: 'Ja. Wenn Sie präventiv arbeiten möchten - Personal Training, Wellness oder vorbeugende Manualtherapie - ist das jederzeit möglich. Es gelten die Sätze des Honorarkatalogs; bitte sprechen Sie mich für ein individuelles Angebot an.',
    },
    {
        question: 'Behandeln Sie auch außerhalb von Sankt Augustin?',
        answer: 'Ich fahre regelmäßig in einem Radius von 30 km. Falls Ihr Wohnort weiter entfernt liegt, sprechen Sie mich gern an - vieles lässt sich individuell einrichten.',
    },
];
    ...
    return {
        ...
        '@graph': [
            ...
            },
            {
                ...
                jobTitle: 'Physiotherapeutin, Manualtherapeutin, Ödemtherapeutin und Personal Trainerin',
